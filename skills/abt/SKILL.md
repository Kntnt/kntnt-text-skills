...
1. `${CLAUDE_PLUGIN_ROOT}/lib/techniques/abt.md` – the technique: the three parts, variants, in medias res, the decisive point that the structure must stay invisible and concrete examples.
